...
const CardTwoT = ({ form, onChangeHandler, onNext, onPrev, onClose, errors }) => {
    return (
        <>
        <div className="relative overflow-hidden">
                ...
                <p className="font-julius text-xs text-center mx-auto md:left-0 md:text-start md:text-base">¡tranquilo! solo llevará unos segundos</p>
                </div>
                <div className="flex justify-center mt-6 mb-2 md:justify-start md:pl-12">                    
                    <input type="text" value={form.telefono} onChange={onChangeHandler} name="telefono" placeholder="Telefono"
