...
const GiftList = () =>{
    ...
    return(
        ...
        <p className="font-julius md:mx-16 text-center md:pt-10 py-4 px-4 text-sm md:text-base">Tu presencia es nuestro mejor regalo pero si queres obsequiarnos algo, podes hacerlo de la siguiente manera:</p>
