...
const Attendance = () =>{
    ...
    return(
        ...
        <p className="font-julius text-center text-xs pb-6 w-3/4 md:text-2xl md:w-1/3">Es muy importante para nosotros que confirmes tu asistencia en este día tan especial</p>
        <div className="border-b border-slate-400 pb-2 w-1/3 mx-auto md:mb-10" ></div>  
        <p className="font-julius text-center text-xs pb-6 w-3/4 pt-8 md:text-2xl md:w-1/3 md:pb-16">En esta ocasión, nuestra invitación no podemos extenderla a los niños, asique la boda será exclusivamente para adultos. ¡Agradecemos tu comprensión!</p>      
